...
$[fg.color=fff ${res['東京']['emoji']}] $[fg.color=f22 ${res['東京']['temp']}]]
$[position.x=5.5,y=8 $[fg.color=fff 大阪]
$[fg.color=fff ${res['大阪']['emoji']}] $[fg.color=f22 ${res['大阪']['temp']}]]
$[position.x=1,y=7 $[fg.color=fff 福岡]
$[fg.color=fff ${res['福岡']['emoji']}] $[fg.color=f22 ${res['福岡']['temp']}]]
$[position.x=10,y=-6 $[fg.color=fff 札幌]
$[fg.color=fff ${res['札幌']['emoji']}] $[fg.color=f22 ${res['札幌']['temp']}]]
